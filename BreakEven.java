...
public class BreakEven implements ActionListener, ChangeListener{ 
	...
	public BreakEven(){
		...
		senzaprofitto.setOpaque(false);
		senzaprofitto.setLocation(40,500);
		senzaprofitto.setSize(new Dimension(300,20));
		senzaprofitto.setVisible(false);
		panel.add(senzaprofitto);
		
		progetto = new JLabel("Progetto di economia");
		progetto.setOpaque(false);
		progetto.setLocation(300, 490);
		progetto.setSize(new Dimension(500,220));
		progetto.setFont(new Font("Serif", Font.BOLD, 30));
		panel.add(progetto);
		
		mezzera = new JLabel("Mezzera Giorgia matr. 1080308");
		mezzera.setOpaque(false);
		mezzera.setLocation(300, 530);
		mezzera.setSize(new Dimension(500,220));
		mezzera.setFont(new Font("Serif", Font.BOLD, 30));
		panel.add(mezzera);
